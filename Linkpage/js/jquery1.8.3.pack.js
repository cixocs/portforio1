...
/*-----------------------------------------------------
jquery1.8.3.pack.js - 2013.07.29
├branch.js v0.1.1
|├isOS
|├isDevice
|└isBrowser
...
(function($) {
    $.extend({
        ...
        isBrowser: function(t, v, i) {
            return isBrowser(t, v, i)
        }
    });
    ...
    var isOS = function(t, v) {
        ...
        if (ua.indexOf('windows') != -1) {
            ...
            if (ua.indexOf('mobile') != -1) {
                if (os == 'ios') {
                    if (v) 
                        return ua.indexOf('os ' + String(v).replace('.', '_')) != -1;
                        return true;
                }
            } else {
                if (os == 'mac') {
    ...
    var isBrowser = function(t, v, i) {
        ...
        var hasBrowser = function(t, v) {
            if (ua.indexOf('msie') != -1 && browser == 'ie') {
                if (v) 
                    return ua.indexOf('msie ' + v + '.') != -1;
                return true;
            } else if (ua.indexOf('firefox') != -1 && browser == 'firefox') {
                if (v) 
                    return ua.indexOf('firefox/' + v + '.') != -1;
                    return true;
            } else if (ua.indexOf('chrome') != -1) {
                if (browser == 'chrome') {
                    if (v) 
                        return ua.indexOf('chrome/' + v + '.') != -1;
                        return true;
...
jQuery.extend(jQuery.easing, {
    ...
    customInOut: function(x, t, b, c, d) {
        var s = 1.70158;
        if ((t/=d / 2) < 1) 
            return c / 2 * (t * t * (((s*=(1.525)) + 1) * t - s)) + b;
        return c / 2 * ((t -= 2) * t * (((s*=(1.525)) + 1) * t + s) + 2) + b;
